...
\subsection{Hasil Pembuatan Poster}

Sebagai salah satu luaran kegiatan, dibuat sebuah infografis edukatif yang mengangkat tema korupsi, moralitas, dan nilai-nilai keagamaan. Infografis ini dirancang untuk menyampaikan informasi secara ringkas dan menarik sehingga lebih mudah dipahami oleh masyarakat. Hasil pembuatan infografis edukatif tersebut dapat dilihat pada Gambar 4.3.

\begin{figure}[H]
            \centering
            \includegraphics[width=8cm]{assets/poster/poster_kelompok2.jpeg}
              \captionsetup{labelformat=empty}
               \caption[Poster "Korupsi: Masalah Hukum atau Krisis Moral?"]{Gambar \ref{fig:POSTERKR} Poster "Korupsi: Masalah Hukum atau Krisis Moral?"}
            \label{fig:POSTERKR}
        \end{figure}

Berdasarkan Gambar 4.3, poster yang kami rancang berjudul "Korupsi: Masalah Hukum atau Krisis Moral?" dibuat menggunakan platform Canva dengan dominasi warna merah tua (\#660B05) yang melambangkan kondisi darurat dan urgensi tinggi terhadap permasalahan korupsi di Indonesia. Aksen emas pada elemen dan tulisan melambangkan kekayaan dan kekuasaan yang kerap menjadi objek godaan dalam praktik korupsi. Perpaduan kedua warna ini menciptakan kontras visual yang menggambarkan pertentangan antara integritas dan godaan materi.

Bagian utama poster menampilkan data \textit{Corruption Perceptions Index} (CPI) Indonesia periode 1995–2025 yang menunjukkan skor Indonesia konsisten berada di bawah angka 40. Data ini dikontraskan dengan fakta bahwa sebagian besar masyarakat Indonesia menganggap agama penting dan rutin menjalankan ibadah, memunculkan pertanyaan kritis mengenai kesenjangan antara religiusitas dan perilaku koruptif. Kata-kata seperti "\textit{corruption}," "\textit{integrity}," "\textit{law}" dan "\textit{faith}" tersebar di latar belakang sebagai refleksi atas hubungan antara keimanan dan integritas.

Ilustrasi \textit{Lady Justice} yang membawa timbangan ditempatkan di bagian tengah poster sebagai simbol hukum, keadilan, dan objektivitas dalam penegakan aturan. Posisinya di antara bagian "akar masalah" dan "solusi" menunjukkan bahwa pemberantasan korupsi memerlukan keseimbangan antara penegakan hukum dan perbaikan moral. Bagian akar masalah mencakup ego dan nafsu yang mengalahkan nilai moral, praktik keagamaan yang bersifat formalitas, serta budaya koruptif yang dinormalisasi.

Bagian solusi menawarkan pendekatan pembentukan karakter melalui rasa syukur, penerapan nilai agama, dan integritas dalam kehidupan bermasyarakat. Bagian bawah poster menampilkan perspektif lintas agama dari Buddha, Kristen, Katolik, Hindu, dan Islam yang menegaskan nilai universal dalam menolak korupsi. Poster ini bertujuan mengajak audiens merefleksikan bahwa korupsi bukan sekadar persoalan hukum, melainkan juga krisis moral yang membutuhkan perubahan karakter dan penerapan nilai-nilai agama dalam kehidupan nyata.

\subsection{Hasil Pembuatan Video}

Video yang kami rancang bertema "Peran Nilai Keagamaan dalam Menanamkan Moral Antikorupsi pada Masyarakat" dengan gaya \textit{dokumenter}. Video ini diproduksi dengan durasi maksimal 3 menit melalui dua tahap utama, yaitu tahap rekaman dan tahap penyuntingan menggunakan software \textit{Adobe Premiere Pro}. Tahap rekaman dilakukan dalam lima sesi terpisah pada bulan Maret dan April di berbagai lokasi kegiatan keagamaan sesuai dengan latar belakang agama masing-masing narasumber.

Bagian awal video menampilkan sekilas tempat ibadah yang kami kunjungi sebagai lokasi wawancara. Video ini berisi wawancara dengan lima pemuka agama, yaitu Aryabodhi Heru Budi Santoso (Buddha), Kevin Manuelim (Kristen), Romo Greg Soetomo SJ (Katolik), perwakilan dari Pasraman Chandra Prabha (Hindu), dan Ustadz Masruchin SHI (Islam), mengenai pandangan terhadap korupsi, akar penyebabnya, serta peran nilai-nilai keagamaan dalam pembentukan karakter antikorupsi. Setiap poin pembahasan didukung oleh teks kutipan penting, ilustrasi, serta data pendukung yang membantu audiens memahami hubungan antara nilai keagamaan dan upaya pencegahan korupsi.

Melalui perspektif lintas agama dari lima narasumber, video ini menyampaikan pesan bahwa pemberantasan korupsi tidak cukup hanya melalui penegakan hukum, tetapi juga membutuhkan perubahan karakter dan internalisasi nilai-nilai keagamaan dalam kehidupan sehari-hari. Lebih dari itu, video ini menegaskan bahwa semangat antikorupsi merupakan nilai universal yang dimiliki oleh seluruh agama, sehingga dapat menjadi fondasi moral bersama dalam membangun masyarakat yang lebih berintegritas.
